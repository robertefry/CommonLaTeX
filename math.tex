...
% Math Function
\NewDocumentCommand{\xf}{D<>{0}m e{_^}}%
{%
    #2%
    \IfValueT{#3}{_{#3}}%
    \IfValueT{#4}{^{#4}}%
...
\NewDocumentCommand{\xfargs}{D<>{0} O{p}g O{p}g O{p}g O{p}g}%
{%
    \IfValueT{#3}{\xgroup<#1>[#2]{#3}}%
    \IfValueT{#5}{\xgroup<#1>[#4]{#5}}%
    \IfValueT{#7}{\xgroup<#1>[#6]{#7}}%
    \IfValueT{#9}{\xgroup<#1>[#8]{#9}}%
}%
...
\xDeclareMathOperator{Set}{\textnormal{Set}}
