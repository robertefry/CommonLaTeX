...
% Math Function
\NewDocumentCommand{\xf}{e{_^} d<>O{.}me{_^}}%
{%
    ...
    {%
        ...
        \IfValueT{#7}{^{#7}}%
    %
    \xfarg%         % recursive step
}%
\NewDocumentCommand{\xfarg}{d<>O{p}ge{_^}}%
{%
    \IfValueT{#3}%
    {%
        \xgroup<#1>[#2]{#3}%
...
\NewDocumentCommand{\xDeclareMathOperator}{m d<>O{.}m}%
{%
    \expandafter\DeclareDocumentCommand\csname #1\endcsname{e{_^}}%
    {%
        \xf<#2>[#3]{#4}_{##1}^{##2}%
    }%
}%

\xDeclareMathOperator{op}{\textnormal{op}}          % opposite
\xDeclareMathOperator{inv}{\textnormal{inv}}        % inverses
\xDeclareMathOperator{Id}{\textnormal{Id}}          % identity

\xDeclareMathOperator{Cat}{\textnormal{\bfseries Cat}}  % category

\xDeclareMathOperator{Set}{\textnormal{Set}}        % set
\xDeclareMathOperator{Grp}{\textnormal{Grp}}        % group
\xDeclareMathOperator{Ring}{\textnormal{Ring}}      % ring
