...
{
    \setbookdimensions{260mm}{188mm}{0.3in}
    \settypeblocksize{8.5in}{6.0in}{*}
    \setlrmargins{*}{*}{1}
    \setulmargins{*}{*}{1}
    \checkandfixthelayout
...
\renewcommand{\footmarksep}{)}
\newcommand{\footmarkfont}{\normalfont\footnotesize\ttfamily}

\AtBeginDocument{
    \settowidth{\footmarkwidth}{\footmarkfont\total{footnote}\footmarksep}
}

\makeatletter\renewcommand\@makefnmark{%
    \hbox{\@textsuperscript{\footmarkfont\@thefnmark}}%
}\makeatother

\makeatletter\renewcommand\@makefntext[1]{
    \noindent\makebox[\footmarkwidth][l]{\footmarkfont\@thefnmark\footmarksep}
    #1\par
}\makeatother
