...
% configure tasks environment for better multicolumn itemisation
\usepackage{tasks}
\settasks{
    label=\textbullet,
    after-item-skip=0.15\baselineskip plus 0.15\baselineskip minus 0.15\baselineskip,
    before-skip=0pt,
    after-skip=0pt,
}
