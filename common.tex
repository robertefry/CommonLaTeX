...
% Proof without QED
\newenvironment{proof*}{\renewcommand{\qedsymbol}{}\proof}{\endproof}
...
\NewDocumentEnvironment{thatis}   {D<>{0em}}{ \begin{block}[m][That is]   }{ \end{block} }
...
\NewDocumentCommand{\DefineTheoremEnvironment}{D<>{0em}mmO{\itshape}}%
{%
    \NewDocumentEnvironment{#2*}{D<>{#1}}{ \begin{block}[m][#3] }{ \end{block} }%
    %
    \newtheoremstyle{#2thmstyle}{\topsep}{\topsep}{#4}{}{\bfseries}{}{\newline}{}%
    \theoremstyle{#2thmstyle}%
    \newtheorem{#2}[counter]{#3}%
    \AfterEndEnvironment{#2}{\goodbreak}%
}%

% Named Theorem Environments
\DefineTheoremEnvironment{definition}{Definition}
\DefineTheoremEnvironment{axiom}{Axiom}
\DefineTheoremEnvironment{postulate}{Postulate}
\DefineTheoremEnvironment{lemma}{Lemma}
\DefineTheoremEnvironment{theorem}{Theorem}
\DefineTheoremEnvironment{corollary}{Corollary}
\DefineTheoremEnvironment{example}{Example}[]
