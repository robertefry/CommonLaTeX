...
% Unify Vector Commands (\vv,\vb)
\DeclareDocumentCommand{\va} {m}{ \vv{#1} }
%\DeclareDocumentCommand{\vb} {m}{ \vb{#1} }
\DeclareDocumentCommand{\vab}{m}{ \vv{\vb{#1}} }
...
%\NewDocumentCommand{\xfunc}{D<>{0}mm}{ \xfunc<#1>[f]{#3}{#4} }
