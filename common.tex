...
\NewDocumentCommand{\MakeNewTheorem}{mm}%
{%
    \newtheorem{#1}{#2}%
    \newframedtheorem{*#1}{#2}%
}%
...
\MakeNewTheorem{Definition}{Definition}[section]
\MakeNewTheorem{Postulate}{Postulate}[section]
\MakeNewTheorem{Lemma}{Lemma}[section]
\MakeNewTheorem{Theorem}{Theorem}[section]
\MakeNewTheorem{Corollary}{Corollary}[section]
\MakeNewTheorem{Example}{Example}[section]
